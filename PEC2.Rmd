...
La diferencia en precisión con los modelos anteriores de 1 y 3 nodos, pero empleando la otra función, no difiere mucho de los resultados obtenidos en este modelo. Es un modelo mucho más robusto que los anteriores, sin embargo, debido al tiempo de ejecución, quizá en este caso no es necesario ejecutarlo, ya que con los modelos anteriores tenemos una buena precisión.
